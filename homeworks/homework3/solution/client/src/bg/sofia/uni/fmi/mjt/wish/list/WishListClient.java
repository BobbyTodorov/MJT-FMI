...
public class WishListClient {
    ...
    private void writeFromBufferToSocketChannel(String msg, SocketChannel sc) throws IOException {
        buffer.clear();
    ...
    private String readFromSocketChannelToBuffer(SocketChannel sc) throws IOException {
        buffer.clear();
        sc.read(buffer);
        buffer.flip();

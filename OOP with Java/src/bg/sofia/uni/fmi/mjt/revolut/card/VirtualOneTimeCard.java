...
public class VirtualOneTimeCard implements Card {
    ...
    private final static String INVALID_PHYSICAL_CARD_STRING = "Invalid Virtual One Time Card Number!";
    private final static String INVALID_PHYSICAL_CARD_PIN_STRING = "Invalid Virtual One Time Card PIn!";
